...
\paragraph*{Rule}
\fbox{
\parbox{.9\linewidth}{\texttt{ADDRELATION (Gram:Det:DetCombi) (Determiner) IF (0 DetAllIncluded) TO (1 ListaDeDeterminantesSegurosSiNoEstanEnMasc OR DemasLiteral OR OtroLema LINK NOT 0 Adverbio);}}
}
\begin{itemize}
\item ETIQ: Asigna @Gram:Det:DetCombi
...
\paragraph*{Rule}
\fbox{
\parbox{.9\linewidth}{\texttt{ADDRELATION (Vocab:Fraseol:LocAdv) UnDetLiteral TO (*1 PocoLema BARRIER LimiteOracionSimple OR GrupoNominal OR Verbo LINK 1C Adj);}}
}
