...
\item DESC: Se aplica sólo a pltíquenos.
\end{itemize}
...
\section{Expresar deseos sobre uno mismo u otros con incertidumbre/en el futuro}
\paragraph*{Rule}
\fbox{
\parbox{.9\linewidth}{\texttt{ADDRELATION (Func:Deseos:Ajenos) Verbo IF (0 VerbosExpresarDeseos) (1 Que) (2 GrupoNominal OR PronombresCliticosTODOS) TO (*3 Verbo + Subjuntivo BARRIER GrupoNominal OR LimiteOracionSimple OR FiniteVerbForms);}}
}
\paragraph*{Rule}
\fbox{
...
\item EJEM: [Pendiente de documentar]
\item DESC: [Pendiente de documentar]
\end{itemize}
